# comando para iniciar: streamlit run "Proyecto final\chat.py"
...
# -------------------------------------------------------------
st.set_page_config(page_title="TalentoChat", page_icon="💕")
st.title("¡Gracias por confiar en Tecni!")  
...
def configurar_pagina():
    st.title("Preguntale a Tecni 🤖")  # <-- Título dentro del chat
